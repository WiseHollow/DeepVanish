 ...
 */
public class CommandVanAdd implements CommandExecutor
{
    @Override
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args)
    {
        ...
        if (!Settings.SilentJoin.contains(player.getUniqueId().toString()))
            Settings.SilentJoin.add(player.getUniqueId().toString());
        sender.sendMessage(Settings.PREFIX + "Added to the Silent Join list.");
        Settings.Save();
